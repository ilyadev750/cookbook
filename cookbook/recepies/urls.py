...
urlpatterns = [
    ...
    path('search_recepies/show_recepies/', show_recepies_without_product,
         name='show_recepies_without_product'),
    path('<str:username>/recepies/', get_user_recepies,
         name='get_user_recepies'),
    path('<str:username>/create_recepie/', create_recepie,
         name='create_recepie'),
    path('<str:username>/delete_recepie/', delete_recepie,
         name='delete_recepie'),
]
